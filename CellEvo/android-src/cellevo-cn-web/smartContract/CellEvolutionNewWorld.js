...
//, cellno, adaption, surviveability, division, environment, day, totoalscore, finaltitle
    dnamerge: function (id, cellno, adaption, surviveability, division, environment, day, totoalscore, finaltitle) {
        ...
        newcellworld.cellsdetail = newcellworld.cellsdetail+id.toString()+","+from+","+cellno.toString()+","+adaption.toString()+","+surviveability.toString()+","+division.toString()+","+environment.toString()+","+day.toString()+","+totoalscore.toString()+","+finaltitle.toString()+","+ newcellworld.id+"|";
    ...
    worldtitlecheck: function(){
        ...
        var inworldno = parseInt(newcellworld.endcellid) - parseInt(newcellworld.startcellid);
        if(inworldno > 100){
