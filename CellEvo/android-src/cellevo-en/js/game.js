...
function aboutusfun() {
    layer.msg("<img src=\"img/neblogo.png \" height=\"70\" width=\"70\"><br>" +
        ...
        time: 0 //不自动关闭
        , anim: 0, btnAlign: 'c', shade: 0.8, area: ['780px', '500px'], btn: ['Next'], closeBtn: 1
...
function displayEndGameUI() {
    ...
    layer.msg(datacollect, {
        time: 0 //不自动关闭
        , btn: ['Next', 'Share'], area: ['480px', '300px'], btnAlign: 'c', shade: 0.8
        , yes: function (index) {
            layer.close(index);
            ...
            var backgroundim = '  <link rel=\"stylesheet\" href=\"css/card.css\"><div class=\"paper\"><img class=\"poster\" src="img/p' + sharepicrandom + '.png"/> <h2>Cell Evolution -- Final Evaluation</h2>  <h1>' + renderAndTranslate(finaltitle) + '</h1> <p>Your cell survive ' + day + ' days, get ' + totoalscore + ' points. Share this cell with your friends!</p>  <img class=\"qrcode\" src=\"img/share.png\"/></div>'
        ...
        yes: function () {
            ...
            for (var i = 0; i < singlecell.length; i++) {
                if (singlecell[i] != "") {
                    ...
                    cellStr = cellStr.replace(new RegExp('僵123尸亚种', 'g'), "Zombie Subtype");
            ...
            var sharepicrandom = randomize(1, 9);
            var backgroundim = '  <link rel=\"stylesheet\" href=\"css/card.css\">' +
                '<div class=\"paper\"><img class=\"poster\" src="img/p' + sharepicrandom + '.png"/> ' +
                '<h2>World - Final Evaluation</h2>  <h1>' + worldtitle + '</h1> ' +
                '<p>No.' + result.id + ' world survived  ' + result.day + ' days, get ' + result.totoalscore + ' points. ' +
                'Share this world with your friends!</p>  <img class=\"qrcode\" src=\"img/share.png\"/></div>'
            layer.msg(backgroundim, {
                time: 0, //不自动关闭
                shadeClose: true,
                area: "70%",
