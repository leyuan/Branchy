...
$('#worlddata').on('click', function () {
    //读取数据
    var worldpromt;
    var worldreadingtxt1;
    var worldreadingtxt2;
    worldpromt = 'Please enter the world ID to get the world info';
    worldreadingtxt1 = 'Reading World <';
    worldreadingtxt2 = '> data ...';

    layer.prompt({
        title: worldpromt, formType: 3, btn: ['Enter', 'Current World', 'Cancel'], btn2: function () {
        ...
        layer.msg(worldreadingtxt1 + pass + worldreadingtxt2);
...
function aboutusfun() {
    layer.msg("<img src=\"img/neblogo.png \" height=\"70\" width=\"70\"><br>" +
        "<div>Cell Evolution need Nebulas wallet to support DNA merging, install one of the following wallet to gain full game experience." +
        "<br>Language: <a href=\"http:\/\/cellevo.net:9320\">中文</a>|<a href=\"http:\/\/cellevo.net:9316\">English</a>" +
        ...
        time: 0 //不自动关闭
        , anim: 0, btnAlign: 'c', shade: 0.8, area: ['80%', '500px'], btn: ['Next'], closeBtn: 1
    });
...
function celldivision() {
    ...
    layer.msg(divinfo, {
        time: 1000 //不自动关闭
        , anim: 0, btnAlign: 'c', shade: 0.8, closeBtn: 0, area: ['80%', '300px'], offset: 't'
...
function displayEndGameUI() {
    ...
    layer.msg(datacollect, {
        time: 0 //不自动关闭
        , btn: ['Next', 'Share'], area: ['80%', '300px'], btnAlign: 'c', shade: 0.8
        , yes: function (index) {
            layer.close(index);
            layer.confirm('<p>Whether go fusion to integrate DNA into the group or not?</p>', {
                type: 0,
                btn: ['Yes', 'No'], anim: 0, btnAlign: 'c', shade: 0.8, closeBtn: 0, area: ['80%', '300px'] //按钮
            }, function () {
            ...
            var backgroundim = '  <link rel=\"stylesheet\" href=\"css/card.css\"><div class=\"paper\"><img class=\"poster\" src="img/p' + sharepicrandom + '.png"/> <h2>Cell Evolution <br>-- Final Evaluation</h2>  <h1>' + renderAndTranslate(finaltitle) + '</h1> <p>Your cell survive ' + day + ' days, get ' + totoalscore + ' points. Share this cell with your friends!</p>  <img class=\"qrcode\" src=\"img/share.png\"/></div>'
...
function callapoptosis() {
    ...
    layer.msg(datacollect, {
        time: 0 //不自动关闭
        , btn: ['Yes', 'No'], area: ['80%', '300px'], btnAlign: 'c', shade: 0.8
        , yes: function (index) {
...
function callinheritance() {
    if (day == 1) {
        ...
        serialNumber = nebPay.call(to, value, func, args, {
            qrcode: {
                showQRCode: false
            },
            goods: {
...
//            listener: inheritancecallback
        ...
        layer.msg('Getting inheritance data...',{shade:0.8,time:30000,shadeClose:true});
...
function onrefreshClick() {
    nebPay.queryPayInfo(serialNumber, {callback: callbackUrl})   //search transaction result from server (result upload to server by app)
        .then(function (resp) {
            closesec++;
            console.log(resp)
            var formal = JSON.parse(resp);
            console.log(formal.msg)
            if (formal.msg == 'success') {
                setTimeout(getinheritance, 2000);
                clearInterval(close);
            } else if (closesec > 7) {
                clearInterval(close);
                layer.msg('Please make sure you install NAS wallet');
            }
...
function cellread() {
    ...
    layer.prompt({
        title: 'Please enter the Cell ID to get the cell info',
        formType: 3,
        btn: ['Enter', 'Cancel']
    }, function (pass, index) {
...
function decideworldtitle(incoming) {
    ...
    if (titlecheck[0].search("高度进化") != -1) {
        titlecheck[0] = '<font color=\"red\"> ' + "High evolution" + '</font>';
    } else if (titlecheck[0].search("热闹") != -1) {
        titlecheck[0] = '<font color=\"gold\"> ' + "Bustling" + '</font>';

    } else {
        titlecheck[0] = '<font color=\"white\"> ' + "Quiet" + '</font>';
    }

    if (titlecheck[1].search("高度适应") != -1) {
        titlecheck[1] = '<font color=\"red\"> ' + "High adaption" + '</font>';
    } else if (titlecheck[1].search("正常适应") != -1) {
        titlecheck[1] = '<font color=\"gold\"> ' + "Normal adaption" + '</font>';
    } else {
        titlecheck[1] = '<font color=\"white\"> ' + "Low adaption" + '</font>';
    }

    if (titlecheck[2].search("高度生存") != -1) {
        titlecheck[2] = '<font color=\"red\"> ' + "High survivability" + '</font>';
    } else if (titlecheck[2].search("正常生存") != -1) {
        titlecheck[2] = '<font color=\"gold\"> ' + "Normal survivability" + '</font>';
    } else {
        titlecheck[2] = '<font color=\"white\"> ' + "Low survivability" + '</font>';
    }

    if (titlecheck[3].search("高度繁殖") != -1) {
        titlecheck[3] = '<font color=\"red\"> ' + "High reproduction" + '</font>';
    } else if (titlecheck[3].search("正常繁殖") != -1) {
        titlecheck[3] = '<font color=\"gold\"> ' + "Normal reproduction" + '</font>';
    } else {
        titlecheck[3] = '<font color=\"white\"> ' + "Low reproduction" + '</font>';
    }
    if (titlecheck[4].search("高度环境抵抗") != -1) {
        titlecheck[4] = '<font color=\"red\"> ' + "High resistance" + '</font>';
    } else if (titlecheck[3].search("正常环境抵抗") != -1) {
        titlecheck[4] = '<font color=\"gold\"> ' + "Normal resistance" + '</font>';
    } else {
        titlecheck[4] = '<font color=\"white\"> ' + "Low resistance" + '</font>';
    }
    worldpictype = "<img src=\"img/p1.png\" height=\"200\" width=\"300\"></img>\n";
    if (titlecheck[5].search("暗物质世界") != -1) {
        worldpictype = "<img src=\"img/p8.png\" height=\"200\" width=\"300\"></img>\n";
        titlecheck[5] = '<font color=\"red\"> ' + "Dark Matter" + '</font>';
    } else if (titlecheck[5].search("盖亚世界") != -1) {
        worldpictype = "<img src=\"img/p7.png\" height=\"200\" width=\"300\"></img>\n";
        titlecheck[5] = '<font color=\"red\"> ' + "Gaia" + '</font>';
    } else if (titlecheck[5].search("岩石世界") != -1) {
        worldpictype = "<img src=\"img/p4.png\" height=\"200\" width=\"300\"></img>\n";
        titlecheck[5] = '<font color=\"gold\"> ' + "Rock world" + '</font>';
    } else if (titlecheck[5].search("海洋世界") != -1) {
        worldpictype = "<img src=\"img/p5.png\" height=\"200\" width=\"300\"></img>\n";
        titlecheck[5] = '<font color=\"gold\"> ' + "Sea world" + '</font>';
    } else if (titlecheck[5].search("机械世界") != -1) {
        worldpictype = "<img src=\"img/p6.png\" height=\"200\" width=\"300\"></img>\n";
        titlecheck[5] = '<font color=\"gold\"> ' + "Mechanical world" + '</font>';
    } else if (titlecheck[5].search("虫族世界") != -1) {
        worldpictype = "<img src=\"img/p3.png\" height=\"200\" width=\"300\"></img>\n";
        titlecheck[5] = '<font color=\"blue\"> ' + "Zerg" + '</font>';
    } else if (titlecheck[5].search("精神世界") != -1) {
        worldpictype = "<img src=\"img/p2.png\" height=\"200\" width=\"300\"></img>\n";
        titlecheck[5] = '<font color=\"violet\"> ' + "Mental world" + '</font>';
    } else {

        titlecheck[5] = '<font color=\"white\"> ' + "Human world" + '</font>';
    }
...
function worldSearch(resp) {
    ...
    layer.msg(datacollect, {
        ...
        yes: function () {
                ...
                if (singlecell[i] != "") {
                    ...
                    for (var key in EngMap) {
                        ...
                        if (key == '僵尸亚种') {
                            ...
                            cellStr = cellStr.replace(regex, EngMap[key]);
                        }
                    }
                    ...
                    var info = "    <div class=\"info-card\">\n" +
                        ...
                        "        Final evaluation: " + singlecellinfo[9] + "\n" +
                        "\n" +
                        "        <div class=\"extra-info\">\n" +
                        "            <h3>Details</h3>\n" +
                        "            Number of cells:: " + singlecellinfo[2] + "</br>\n" +
                        "            Adaptability: " + singlecellinfo[3] + "</br>\n" +
                        "            Survivability: " + singlecellinfo[4] + "</br>\n" +
                        "            Reproductivity: " + singlecellinfo[5] + "</br>\n" +
                        "            External environment: " + singlecellinfo[6] + "</br>\n" +
                        "            Survival day: " + singlecellinfo[7] + "</br>\n" +
                        "            Overall score: " + singlecellinfo[8] + "</br>\n" +
                        "            Final evaluation: " + singlecellinfo[9] + "</br>\n" +
                        "            Creator: " + singlecellinfo[1] + "</br>\n" +
                        "            Ecological Group: " + singlecellinfo[10] + "</br>\n" +
                        "        </div>\n" +
                        "    </div>"
            ...
            var sharepicrandom = randomize(1, 9);
            var backgroundim = '  <link rel=\"stylesheet\" href=\"css/card.css\"><div class=\"paper\"><img class=\"poster\" src="img/p' + sharepicrandom + '.png"/> <h2>World - Final Evaluation</h2>  <h1>' + worldtitle + '</h1> <p>No.' + result.id + ' world survived  ' + result.day + ' days, get ' + result.totoalscore + ' points。Share this world with your friends!</p>  <img class=\"qrcode\" src=\"img/share.png\"/></div>'
            layer.msg(backgroundim, {
                time: 0, //不自动关闭
                shadeClose: true,
                area: "70%",
...
function cellSearch(resp) {
    ...
    layer.msg(newdatacollect, {
        ...
        , shadeClose: true
        , btn: ['Enter']
        , anim: 0, btnAlign: 'c', shade: 0.6, closeBtn: 0, area: ['80%', '60%'], offset: 'c'
    });
    console.log("recived by page:" + e + ", e.data:" + JSON.stringify(e.data));
}
