...
if (typeof(webExtensionWallet) != "undefined") {
    ...
    layer.msg(' 请安装最新的IOST钱包后刷新~ 点击游戏页面More Info也可以直接开启传送阵!!! ');
    ...
    if (day == 1) {
        ...
        window.IWalletJS.enable().then((account) => {
            ...
            iost.signAndSend(ctx).on('pending', (trx) => {
                ...
                .on('failed', (failed) => {
                    console.log(failed, 'failed')
                    // layer.msg('Failed to get Inheritance Info!');
                })
...
function getinheritance() {
    ...
    console.log(inheritancearray);
    inheritancearray.push(parseInt(0));
    inheritanceSearch(JSON.stringify(inheritancearray));
    // inheritanceSearch(inheritancearray);
//
...
function worldSearch(resp) {
    ...
    layer.msg(datacollect, {
              ...
              "        <div class=\"label\">最终评价: </div>" + renderAndTranslateNew(singlecellinfo[9]) + "\n" +
                  "     <br>   创造者: " + singlecellinfo[1] + "\n" +
              "\n" +
              "        <div class=\"extra-info\">\n" +
              "            <h3>详细信息</h3>\n" +
              "            <div class=\"label\">细胞数: </div>" + singlecellinfo[2] + "</br>\n" +
              "            <div class=\"label\">适应性: </div>" + singlecellinfo[3] + "</br>\n" +
              "            <div class=\"label\">生存性: </div>" + singlecellinfo[4] + "</br>\n" +
              "            <div class=\"label\">繁殖性: </div>" + singlecellinfo[5] + "</br>\n" +
              "            <div class=\"label\">外部环境: </div>" + singlecellinfo[6] + "</br>\n" +
              "            <div class=\"label\">存活日: </div>" + singlecellinfo[7] + "</br>\n" +
              "            <div class=\"label\">总体得分: </div>" + singlecellinfo[8] + "</br>\n" +
              "            <div class=\"label\">最终评价: </div>" + renderAndTranslateNew(singlecellinfo[9]) + "</br>\n" +
              "            <div class=\"label\">细胞创造者: </div>" + singlecellinfo[1] + "</br>\n" +
              "            <div class=\"label\">所属族群: </div>" + singlecellinfo[10] + "</br>\n" +
              "        </div>\n" +
              "    </div>";
...
function cellSearch(finalData) {
    ...
    imgpic +
    "        </i>\n" +
    "       <h1>编号<" + finalData.id + ">细胞数据</h1>\n" +
    "        <h2>细胞数: " + finalData.cellno + "</h2>\n" +
    "        最终评价: " + renderAndTranslateNew(finalData.finaltitle) + "</br>\n" +
        "        Creator: " + finalData.creator + "\n" +
        "            <h3>详细信息</h3>\n" +
    "             细胞数:  " + finalData.cellno + "</br>\n" +
    "            适应性: " + finalData.adaption + "</br>\n" +
    "            生存性: " + finalData.surviveability + "</br>\n" +
    "            繁殖性: " + finalData.division + "</br>\n" +
    "            外部环境: " + finalData.environment + "</br>\n" +
    "            存活日: " + finalData.day + "</br>\n" +
    "            总体得分: " + finalData.totoalscore + "</br>\n" +
    "            最终评价: " + renderAndTranslateNew(finalData.finaltitle) + "</br>\n" +
    "            细胞创造者: " + finalData.creator + "</br>\n" +
    "            所属族群: " + finalData.belong + "</br>\n" +
    "    </div>"
...
function inheritanceSearch(resp) {
    ...
    var resultString = JSON.parse(resp);
    ...
    var datacollect = '<img src=\"img/dna7.png \" height=\"96\" width=\"60\" id=\"jinhua\"></img>' + '<div>' + '' + singlein[3] + ' 遗传信息</div><br>' + d3 + '<br>' + d1 + '<br>' + d2;
...
},{"iost":62}],2:[function(require,module,exports){
...
},{"../core/createError":10,"./../core/settle":13,"./../helpers/btoa":17,"./../helpers/buildURL":18,"./../helpers/cookies":20,"./../helpers/isURLSameOrigin":22,"./../helpers/parseHeaders":24,"./../utils":26,"_process":101}],4:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":3,"./adapters/xhr":3,"./helpers/normalizeHeaderName":23,"./utils":26,"_process":101}],16:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":16,"is-buffer":79}],27:[function(require,module,exports){
...
},{"safe-buffer":83}],28:[function(require,module,exports){
...
},{"buffer":98}],29:[function(require,module,exports){
var r;
...
},{"crypto":98}],30:[function(require,module,exports){
var basex = require('base-x')
var ALPHABET = '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz'

module.exports = basex(ALPHABET)

},{"base-x":27}],31:[function(require,module,exports){
(function (Buffer){
(function () {
  "use strict";
...
},{"../package.json":47,"./elliptic/curve":35,"./elliptic/curves":38,"./elliptic/ec":39,"./elliptic/eddsa":42,"./elliptic/utils":46,"brorand":29}],33:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"bn.js":28}],34:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"../curve":35,"bn.js":28,"inherits":61}],35:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"../curve":35,"bn.js":28,"inherits":61}],37:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"../curve":35,"bn.js":28,"inherits":61}],38:[function(require,module,exports){
'use strict';
...
},{"../elliptic":32,"./precomputed/secp256k1":45,"hash.js":48}],39:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"./key":40,"./signature":41,"bn.js":28,"hmac-drbg":60}],40:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"bn.js":28}],41:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"bn.js":28}],42:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"./key":43,"./signature":44,"hash.js":48}],43:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32}],44:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":32,"bn.js":28}],45:[function(require,module,exports){
module.exports = {
  doubles: {
    step: 4,
    points: [
...
},{"bn.js":28,"minimalistic-assert":81,"minimalistic-crypto-utils":82}],47:[function(require,module,exports){
module.exports={
  ...
  "_where": "/Users/xiaowu/Documents/Github/homepage/Branchy/CellEvo/android-src/cellevo-en-web-iost/node_modules/iost",
  "author": {
    "name": "Fedor Indutny",
...
},{"./hash/common":49,"./hash/hmac":50,"./hash/ripemd":51,"./hash/sha":52,"./hash/utils":59}],49:[function(require,module,exports){
'use strict';
...
},{"./utils":59,"minimalistic-assert":81}],50:[function(require,module,exports){
'use strict';
...
},{"./utils":59,"minimalistic-assert":81}],51:[function(require,module,exports){
'use strict';
...
},{"./common":49,"./utils":59}],52:[function(require,module,exports){
'use strict';
...
},{"./sha/1":53,"./sha/224":54,"./sha/256":55,"./sha/384":56,"./sha/512":57}],53:[function(require,module,exports){
'use strict';
...
},{"../common":49,"../utils":59,"./common":58}],54:[function(require,module,exports){
'use strict';
...
},{"../utils":59,"./256":55}],55:[function(require,module,exports){
'use strict';
...
},{"../common":49,"../utils":59,"./common":58,"minimalistic-assert":81}],56:[function(require,module,exports){
'use strict';
...
},{"../utils":59,"./512":57}],57:[function(require,module,exports){
'use strict';
...
},{"../common":49,"../utils":59,"minimalistic-assert":81}],58:[function(require,module,exports){
'use strict';
...
},{"inherits":61,"minimalistic-assert":81}],60:[function(require,module,exports){
'use strict';
...
},{"hash.js":48,"minimalistic-assert":81,"minimalistic-crypto-utils":82}],61:[function(require,module,exports){
...
},{"./iost/account":63,"./iost/iost":65,"./iost/tx_handler":66,"./lib/crypto/algorithm":68,"./lib/crypto/key_pair":71,"./lib/provider/HTTPProvider":74,"./lib/rpc":75,"./lib/structs":76}],63:[function(require,module,exports){
class Account {
    constructor(id) {
        this._id = id;
        this._key_id = {};
...
module.exports = IOST;
},{"../lib/rpc":75,"../lib/structs":76,"./callback":64,"./tx_handler":66}],66:[function(require,module,exports){
const {Tx} = require('../lib/structs');
...
},{"../lib/structs":76}],67:[function(require,module,exports){
/**
 * 区块链相关RPC接口的实现
 * @constructor
...
},{"buffer":99,"long":80,"sha3":84}],70:[function(require,module,exports){
(function () {
...
},{"./algorithm":68,"./crc32":70,"bs58":30,"buffer":99,"elliptic":32,"tweetnacl":78}],72:[function(require,module,exports){
(function (Buffer){
...
},{"./algorithm":68,"./codec":69,"bn.js":28,"btoa":31,"buffer":99,"elliptic":32,"tweetnacl":78}],73:[function(require,module,exports){
/**
 * 查询当前节点信息的接口
 * @constructor
...
},{"axios":2}],75:[function(require,module,exports){
...
module.exports = RPC;
},{"./blockchain":67,"./net":73,"./transaction":77}],76:[function(require,module,exports){
...
},{"./crypto/codec":69,"./crypto/key_pair":71,"./crypto/signature":72,"sha3":84}],77:[function(require,module,exports){
/**
 *
 * @constructor
...
},{"crypto":98}],79:[function(require,module,exports){
/*!
...
},{"buffer":99}],84:[function(require,module,exports){
...
},{"./sponge":85,"buffer":99}],85:[function(require,module,exports){
...
},{"./permute":88,"buffer":99}],86:[function(require,module,exports){
...
},{"../copy":87}],87:[function(require,module,exports){
...
},{"./chi":86,"./iota":89,"./rho-pi":91,"./theta":95}],89:[function(require,module,exports){
...
},{"../xor":96,"./round-constants":90}],90:[function(require,module,exports){
...
},{"../copy":87,"../rotate":94,"./pi-shuffles":92,"./rho-offsets":93}],92:[function(require,module,exports){
...
},{"../copy":87,"../rotate":94,"../xor":96}],96:[function(require,module,exports){
...
},{"base64-js":97,"ieee754":100}],100:[function(require,module,exports){
